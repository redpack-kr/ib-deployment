...
export interface CTokenNoInterestInterface extends utils.Interface {
  functions: {
...
export interface CTokenNoInterest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTokenNoInterestInterface;
