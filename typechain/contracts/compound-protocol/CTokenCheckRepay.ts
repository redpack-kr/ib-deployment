...
export interface CTokenCheckRepayInterface extends utils.Interface {
  functions: {
...
export interface CTokenCheckRepay extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTokenCheckRepayInterface;
