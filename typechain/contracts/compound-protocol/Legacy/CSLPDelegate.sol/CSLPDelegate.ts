...
export interface CSLPDelegateInterface extends utils.Interface {
  functions: {
    ...
    "slpSupplierIndex(address)": FunctionFragment;
    "slpSupplyState()": FunctionFragment;
    ...
    "xSushiUserAccrued(address)": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "slpSupplierIndex",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
    functionFragment: "slpSupplyState",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "xSushiUserAccrued",
    values: [PromiseOrValue<string>]
  ): string;
...
export interface CSLPDelegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CSLPDelegateInterface;
  ...
  estimateGas: {
    ...
    slpSupplyState(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    slpSupplyState(overrides?: CallOverrides): Promise<PopulatedTransaction>;
