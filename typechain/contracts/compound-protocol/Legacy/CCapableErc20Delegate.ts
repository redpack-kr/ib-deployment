...
export interface CCapableErc20DelegateInterface extends utils.Interface {
  functions: {
...
export interface CCapableErc20Delegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CCapableErc20DelegateInterface;
