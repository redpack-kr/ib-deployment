...
export interface CTokenDeprecatedInterface extends utils.Interface {
  functions: {
...
export interface CTokenDeprecated extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CTokenDeprecatedInterface;
