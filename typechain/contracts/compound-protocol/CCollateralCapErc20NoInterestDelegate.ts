...
export interface CCollateralCapErc20NoInterestDelegateInterface
  extends utils.Interface {
  functions: {
    "EVIL_SPELL()": FunctionFragment;
  ...
  decodeFunctionResult(functionFragment: "EVIL_SPELL", data: BytesLike): Result;
...
export interface CCollateralCapErc20NoInterestDelegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CCollateralCapErc20NoInterestDelegateInterface;
  ...
  functions: {
    EVIL_SPELL(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    EVIL_SPELL(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    EVIL_SPELL(overrides?: CallOverrides): Promise<PopulatedTransaction>;
