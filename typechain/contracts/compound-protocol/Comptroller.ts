...
export interface ComptrollerInterface extends utils.Interface {
  functions: {
    ...
    "_delistMarket(address,bool)": FunctionFragment;
    ...
    "_setCreditLimit(address,address,uint256)": FunctionFragment;
    "_setCreditLimitManager(address)": FunctionFragment;
    ...
    "isCreditAccount(address,address)": FunctionFragment;
    "isMarketDelisted(address)": FunctionFragment;
    "isMarketListed(address)": FunctionFragment;
    "isMarketListedOrDelisted(address)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "_setCreditLimitManager",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isMarketListedOrDelisted",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  events: {
    ...
    "CreditLimitChanged(address,address,uint256)": EventFragment;
    "Failure(uint256,uint256,uint256)": EventFragment;
    "MarketDelisted(address,bool)": EventFragment;
    ...
    "NewCreditLimitManager(address,address)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "NewCreditLimitManager"): EventFragment;
...
export interface MarketDelistedEventObject {
  cToken: string;
  force: boolean;
}
export type MarketDelistedEvent = TypedEvent<
  [string, boolean],
  MarketDelistedEventObject
>;
...
export interface NewCTokenVersionEventObject {
  cToken: string;
  oldVersion: number;
  newVersion: number;
}
...
export interface NewCreditLimitManagerEventObject {
  oldCreditLimitManager: string;
  newCreditLimitManager: string;
}
export type NewCreditLimitManagerEvent = TypedEvent<
  [string, string],
  NewCreditLimitManagerEventObject
>;

export type NewCreditLimitManagerEventFilter =
  TypedEventFilter<NewCreditLimitManagerEvent>;
...
export interface Comptroller extends BaseContract {
  ...
  functions: {
    ...
    _setCreditLimitManager(
      newCreditLimitManager: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
    ...
    _setLiquidityMining(
      newLiquidityMining: PromiseOrValue<string>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "CreditLimitChanged(address,address,uint256)"(
      protocol?: null,
      market?: null,
      creditLimit?: null
    ...
    "MarketDelisted(address,bool)"(
      cToken?: null,
      force?: null
    ): MarketDelistedEventFilter;
    MarketDelisted(cToken?: null, force?: null): MarketDelistedEventFilter;
    ...
    "NewCreditLimitManager(address,address)"(
      oldCreditLimitManager?: null,
      newCreditLimitManager?: null
    ): NewCreditLimitManagerEventFilter;
    NewCreditLimitManager(
      oldCreditLimitManager?: null,
      newCreditLimitManager?: null
    ): NewCreditLimitManagerEventFilter;
