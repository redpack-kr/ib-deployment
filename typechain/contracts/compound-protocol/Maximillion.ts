...
export interface MaximillionInterface extends utils.Interface {
  functions: {
    "cWrappedNative()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "cWrappedNative",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface Maximillion extends BaseContract {
  ...
  functions: {
    cWrappedNative(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    cWrappedNative(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    cWrappedNative(overrides?: CallOverrides): Promise<PopulatedTransaction>;
