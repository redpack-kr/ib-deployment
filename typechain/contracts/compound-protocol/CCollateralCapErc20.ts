...
export interface CCollateralCapErc20Interface extends utils.Interface {
  functions: {
...
export interface CCollateralCapErc20 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CCollateralCapErc20Interface;
