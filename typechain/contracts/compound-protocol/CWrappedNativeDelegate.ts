...
export interface CWrappedNativeDelegateInterface extends utils.Interface {
  functions: {
...
export interface CWrappedNativeDelegate extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CWrappedNativeDelegateInterface;
