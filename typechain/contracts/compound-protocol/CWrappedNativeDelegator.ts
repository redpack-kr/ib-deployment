...
export interface CWrappedNativeDelegatorInterface extends utils.Interface {
  functions: {
...
export interface CWrappedNativeDelegator extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CWrappedNativeDelegatorInterface;
