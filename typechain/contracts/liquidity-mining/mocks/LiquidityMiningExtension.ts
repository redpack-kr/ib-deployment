...
export interface LiquidityMiningExtensionInterface extends utils.Interface {
  functions: {
...
export interface LiquidityMiningExtension extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LiquidityMiningExtensionInterface;
